...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex h-dvh w-full overflow-hidden bg-[#050816]">
      ...
      {/* Left Panel — Hero */}
      <div className="relative z-10 hidden h-dvh w-full flex-col justify-between px-10 py-8 lg:flex lg:w-[54%] xl:px-16 2xl:px-24">
        ...
        <div className="relative z-10 max-w-[650px]">
          <motion.h1
            {...fadeUp(0.15)}
            className="text-[56px] font-bold leading-[1.08] tracking-tight text-white 2xl:text-[68px]"
          >
          ...
          <motion.p
            {...fadeUp(0.25)}
            className="mt-5 max-w-[520px] text-[18px] leading-[1.55] text-[#a7b0c3] 2xl:text-[20px]"
          >
      ...
      {/* Right Panel — Login */}
      <div className="relative z-10 flex h-dvh w-full items-center justify-center px-6 py-4 lg:w-[46%]">
        ...
        >
          <GlassCard glow className="rounded-[30px] px-8 py-8 sm:px-10 sm:py-9">
            ...
            {/* Heading */}
            <motion.div {...fadeUp(0.18)} className="mt-5 text-center">
            ...
            {/* Form */}
            <motion.form {...fadeUp(0.26)} className="mt-7 space-y-4" onSubmit={showForgotPassword ? handleForgotPassword : handleSubmit}>
              {/* Email field */}
              ...
              {showForgotPassword ? (
                ...
                <AppButton type="submit" className="relative h-13 w-full rounded-2xl text-[15px] font-semibold" disabled={loading}>
            ...
            {/* Divider with dot */}
            <motion.div {...fadeUp(0.34)} className="relative my-6 flex items-center">
